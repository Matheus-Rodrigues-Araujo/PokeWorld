    ...
    <div class="d-flex flex-column flex-md-row gap-md-3 flex-grow-1 " style="color: var(--lighter-gray)">
      ...
      <svg
        ...
        >
          ...
          <select id="selectLanguage" class="bg-black border-0 text-white">
            <option value="lowest-number" style="background-color: var(--light-gray);" >Lowest Number</option>
            <option value="highest-number" style="background-color: var(--light-gray);">Highest Number</option>
            <option value="a-z" style="background-color: var(--light-gray);">A-Z</option>
            <option value="z-a" style="background-color: var(--light-gray);">Z-A</option>
          </select>
        </label>
    </div>
  </div>
